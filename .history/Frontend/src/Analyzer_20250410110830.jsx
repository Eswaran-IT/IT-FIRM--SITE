...
const COLORS = [
  "#34d399", "#10b981", "#06b6d4", "#3b82f6", "#8b5cf6", "#ec4899",
  "#f59e0b", "#ef4444", "#14b8a6", "#6366f1", "#e11d48", "#84cc16",
];
    ...
    const fetchAnalytics = async () => {
      try {
        ...
        const processedData = {
          ...
          visitorsByCountry: (result.data.visitorsByCountry || [])
            .filter((entry) => entry.country && entry.country.trim() !== "")
            .map((entry) => ({
              ...entry,
