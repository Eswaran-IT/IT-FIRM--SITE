...
const Services = () => {
  ...
  return (
    <section
      className="relative py-8 md:py-2 flex flex-col items-center justify-center min-h-screen"
      style={{
    ...
    >
      ...
      <div className="relative w-full flex justify-center items-center h-72 sm:h-80 overflow-hidden mt-6 md:mt-0 z-10">
        {/* Left arrow */}
        <button
