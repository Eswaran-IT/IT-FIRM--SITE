...
const Homepage = () => {
  ...
  return (
    <section
      data-section="hero"
      className="relative flex flex-col justify-center min-h-[520px] bg-cover bg-center transition-transform"
    >
      {/* Background Video */}
      ...
      <div className="relative flex-grow flex items-center py-8 md:py-12">
        <div className="container mx-auto max-w-5xl px-4 text-white space-y-6">
          ...
          <div className="description-box bg-black/60 border-2 border-green-400 p-5 md:p-6 rounded-lg shadow-lg transition hover:scale-105 hover:shadow-green-500">
