  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-around items-center gap-6 text-center md:text-left">
        ...
        {/* Map - slightly smaller and tighter spacing */}
        <div className="w-full md:w-[280px] h-[180px] bg-gray-800 rounded-lg overflow-hidden shadow-lg">
  <iframe
    ...
    style={{
      border: 0,
      pointerEvents: 'auto'  // ✅ This ensures it's interactive!
    }}
  ></iframe>
</div>
