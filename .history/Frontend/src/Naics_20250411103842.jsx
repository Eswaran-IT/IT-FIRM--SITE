...
const Naics = () => {
  return (
    <section 
      ...
      className="bg-white border-t-2 border-green-400 pt-10 md:pt-6 pb-4 md:pb-1"
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-20">
        ...
        <div className="grid gap-6 
          ...
          auto-rows-[140px] md:auto-rows-[160px] lg:auto-rows-[200px] mb-0"
        >
          {naicsList.map((item, index) => (
            <motion.div
              key={index}
              className={`flex items-center justify-center bg-gray-100 p-4 border-2 border-green-400 rounded-lg shadow-md text-center
