...
const AboutUs = () => {
  ...
  return (
    <section
      id="about-section"
      className="relative flex flex-col items-center justify-center w-full h-screen bg-black overflow-hidden md:py-6"
    >
      ...
      {/* Main Content Box */}
      <motion.div
        className="description-box text-white text-center max-w-3xl relative z-10 p-6 mt-4 md:mt-2 md:py-10 md:min-h-[300px]"
