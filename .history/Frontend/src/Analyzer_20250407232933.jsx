...
const COLORS = ["#22d3ee", "#f472b6", "#34d399", "#60a5fa", "#facc15", "#c084fc"];
  ...
  return (
    <div className="h-[100vh] overflow-hidden bg-black px-4 py-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <ChartCard title="📱 Device Usage by Country">
          <ResponsiveContainer>
            <PieChart>
              <Pie
                data={data.devices || []}
        ...
        {/* Browser Usage Doughnut */}
        <ChartCard title="🌐 Browser Usage by Country">
          <ResponsiveContainer>
            <PieChart>
              <Pie
                data={data.browsers || []}
        ...
        {/* OS Usage Horizontal Bar */}
        <ChartCard title="🖥️ OS Usage by Country">
          <ResponsiveContainer>
            <BarChart
              data={data.os || []}
              layout="vertical"
