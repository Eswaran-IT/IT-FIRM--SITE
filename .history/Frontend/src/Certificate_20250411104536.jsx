...
const Certificate = () => {
  ...
  return (
    <section
      ...
      className="bg-black py-12 sm:py-12 md:py-8 lg:py-12"
    >
      {/* Title with clean spacing below on tablet */}
      <motion.h1
      ...
      {/* Certificates Grid */}
      <div className="flex flex-col sm:flex-row justify-center items-center gap-y-6 sm:gap-y-0 sm:gap-x-8 md:min-h-[30vh]">
