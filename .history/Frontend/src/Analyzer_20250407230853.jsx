    ...
    <div className="h-[100vh] overflow-y-auto bg-black px-4 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <ChartContainer title="📂 Section Views">
          <ResponsiveContainer>
            <ComposedChart data={data.sectionCounts || []}>
              <CartesianGrid strokeDasharray="3 3" />
        ...
        <ChartContainer title="⏰ Peak Hours (24h Scatter)">
          <ResponsiveContainer>
            <ScatterChart>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="hour" name="Hour" type="number" stroke="#ccc" />
              <YAxis dataKey="count" name="Count" type="number" stroke="#ccc" />
              <Tooltip />
              <Scatter data={data.peakHours || []} fill="#3b82f6" />
            </ScatterChart>
          </ResponsiveContainer>
        </ChartContainer>
        ...
        <ChartContainer title="🖥️ OS Usage">
          <ResponsiveContainer>
            <PieChart>
              <Pie data={data.os || []} dataKey="count" nameKey="name" cx="50%" cy="50%" outerRadius={80} label>
