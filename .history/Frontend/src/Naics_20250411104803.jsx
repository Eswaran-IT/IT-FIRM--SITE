...
const Naics = () => {
  return (
    <section 
      ...
      className="min-h-screen flex flex-col justify-start py-16 md:py-6 bg-black border-t-2 border-green-400"
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-20 md:pb-0 md:pt-4">
