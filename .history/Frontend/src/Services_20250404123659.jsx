...
import servicesBg from "./assets/services.jpg"; // Background image
...
const ServiceCard = ({ animation, title, index, activeIndex, totalServices, backgroundImage }) => {
  ...
  const cardSize = "w-64 h-64"; // Square shape with same width & height
  ...
  return (
    ...
    >
      ...
      {/* Square Styled Card with Effects */}
...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      {/* Carousel Container with Drag Interaction */}
      <motion.div
