...
const Certificate = () => {
  ...
  return (
    <section data-section="certificates" className="bg-black py-12">
      ...
      <motion.h1
        className="text-center text-3xl sm:text-4xl font-bold text-white mb-6"
        ...
        {[C1, C2].map((cert, index) => (
          ...
          >
            <img
              ...
              className="h-48 sm:h-52 md:h-56 w-auto object-contain rounded-lg" // Size Minimized
            />
          </motion.div>
        ))}
      </div>
