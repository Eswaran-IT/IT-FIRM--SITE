...
const Certificate = () => {
  ...
  return (
    <section
      ...
      className="bg-white py-12 sm:py-12 md:py-4 lg:py-12"
    >
      {/* Certifications Title */}
      <motion.h1
        className="text-center text-3xl sm:text-4xl font-bold text-black mb-6 md:mb-4"
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-y-6 sm:gap-y-0 sm:gap-x-8 md:min-h-[50vh]">
        {[C1, C2].map((cert, index) => (
          <motion.div
            ...
            className="p-2 border border-green-400 rounded-lg shadow-md bg-gray-100"
