...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white px-6 py-10 relative">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center relative z-10">
        {/* Left Section */}
        <motion.div
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true }}
          className="w-full h-52 md:h-60 rounded-lg overflow-hidden shadow-lg"
        >
          <a
