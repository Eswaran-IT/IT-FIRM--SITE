...
const AboutUs = () => {
  ...
  return (
    <section
      id="about-section"
      className="relative flex flex-col items-center justify-center w-full min-h-[80vh] md:min-h-[88vh] bg-black overflow-hidden py-10 md:py-8"
    >
      {/* Background Video */}
      ...
      {/* Description Box */}
      <motion.div
        className="text-white text-center max-w-3xl relative z-10 p-6 mt-4 md:mt-5"
