...
const Homepage = () => {
    ...
    const generateBubbles = () => {
      const newBubbles = Array.from({ length: 20 }).map(() => ({
        ...
        left:
          Math.random() < 0.5
            ? Math.random() * 10 + 2
            : 90 + Math.random() * 10, // Left/Right corner
  ...
  return (
    <section
      data-section="hero"
      className="relative flex h-screen min-h-[600px] flex-col pt-24 md:pt-16 lg:pt-24 duration-300 bg-cover bg-center transition-transform"
    >
      {/* Video Background */}
      <video
        autoPlay
      ...
      <section className="relative flex grow items-center transition-all duration-700">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="space-y-6 max-w-2xl py-6 md:py-4 lg:py-8">
            {/* Welcome Text with Flash & 3D Glow */}
            <h3
              className="text-xl capitalize text-white border-l-4 pl-4 border-green-400 
            ...
            <div className="description-box relative p-6 md:py-4 lg:py-8 bg-black/50 text-white border-2 border-green-400 rounded-lg shadow-lg transition-all duration-500 hover:scale-105 hover:shadow-green-500">
