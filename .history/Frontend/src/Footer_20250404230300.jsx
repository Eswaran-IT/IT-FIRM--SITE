...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white px-4 py-10 relative">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center md:items-start gap-2 md:gap-3 relative z-10">
        {/* Left: Company Info */}
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-center md:text-left space-y-1 w-full md:w-auto"
        >
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true }}
          className="w-full md:w-96 h-60 rounded-lg overflow-hidden shadow-lg"
        >
          <iframe
