...
const Naics = () => {
  return (
    <section 
      ...
      className="bg-black border-t-2 border-green-400 pt-10 md:pt-6 pb-4 md:pb-1"
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-20">
        ...
        >
          {naicsList.map((item, index) => (
            <motion.div
              key={index}
              className={`flex items-center justify-center bg-gray-900 p-4 border-2 border-green-400 rounded-lg shadow-md text-center
