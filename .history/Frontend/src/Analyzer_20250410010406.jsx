...
const StatCard = ({ title, value, icon }) => (
  <motion.div
    className="bg-white/10 p-5 rounded-2xl shadow-lg hover:shadow-indigo-400 transition-all duration-300 flex flex-col items-center justify-center text-center w-full sm:w-48 text-white backdrop-blur-md"
...
const ChartCard = ({ title, children }) => (
  <motion.div
    className="bg-white/5 p-4 rounded-2xl shadow-md text-white h-full backdrop-blur-lg"
...
const Analyzer = () => {
  ...
  return (
    <div className="h-screen overflow-auto bg-gradient-to-br from-gray-950 via-indigo-950 to-gray-900 px-4 py-4">
      <motion.h1
        className="text-3xl font-extrabold text-center mb-5 text-indigo-400"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5 }}
      >
        📊 Sleek Analytics Dashboard
      </motion.h1>
        ...
        <ChartCard title="🌍 Country Visitors">
          <ResponsiveContainer>
            ...
            >
              ...
              <Tooltip formatter={(value) => [`${value} visitors`, "Total"]} />
