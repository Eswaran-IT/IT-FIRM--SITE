...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white px-4 py-8 relative">
      <div className="absolute inset-0 bg-green-400 opacity-10 blur-3xl pointer-events-none"></div>

      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-around items-center gap-2 md:gap-4 relative z-10">
        {/* Left: Info */}
        <motion.div
        ...
        >
          <h2 className="text-xl font-semibold text-green-400">GS Tech Groups LLC</h2>
          <p className="text-gray-300 text-sm">
            14441 Eastbrook Dr, El Paso, TX 79938
          </p>

          <div className="flex justify-center md:justify-start items-center gap-1 text-sm">
            <FiPhone className="text-green-400 text-lg" />
            <span>804-892-4713</span>
          </div>

          <p className="text-sm">✉️ gstechgroups1@gmail.com</p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
          viewport={{ once: true }}
          className="w-full md:w-80 h-48 rounded-lg overflow-hidden shadow-lg"
        >
          <iframe
