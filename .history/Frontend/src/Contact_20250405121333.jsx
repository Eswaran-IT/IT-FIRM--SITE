...
const SuccessModal = ({ onClose }) => {
  return (
    ...
    >
      <div className="bg-white text-black rounded-xl p-6 max-w-sm w-full shadow-2xl relative">
        <button
          onClick={onClose}
        ...
        <h3 className="text-lg font-semibold mb-2 text-green-600">Thank you!</h3>
