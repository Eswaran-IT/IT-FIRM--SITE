...
const Naics = () => {
  return (
    <section 
      ...
      className="min-h-screen flex flex-col justify-start py-12 md:py-4 bg-black border-t-2 border-green-400"
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-20 md:pb-4 md:pt-2">
