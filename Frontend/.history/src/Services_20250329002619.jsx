  ...
  return (
    <section className="py-20 bg-black flex flex-col items-center relative w-full">
      ...
      <div className="relative w-full flex justify-center items-center mt-12">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-1/4 z-10 bg-green-500 p-5 rounded-full shadow-lg hover:bg-green-600 transition"
        >
        ...
        <button
          onClick={nextSlide}
          className="absolute right-1/4 z-10 bg-green-500 p-5 rounded-full shadow-lg hover:bg-green-600 transition"
        >
